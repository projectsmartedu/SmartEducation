...
print(f"   Intervention: {'Immediate mentor + weekly 1-on-1' if score_high > 0.66 else 'Monitor closely' if score_high > 0.33 else 'Standard support'}")
...
print(f"   Intervention: {'Immediate mentor + weekly 1-on-1' if score_low > 0.66 else 'Monitor closely' if score_low > 0.33 else 'Standard support'}")
...
print(f"   Recommendation: {'Start revision immediately' if score_urgent > 0.66 else 'Schedule soon' if score_urgent > 0.33 else 'Continue current pace'}")
...
print(f"   Recommendation: {'Start revision immediately' if score_not_urgent > 0.66 else 'Schedule soon' if score_not_urgent > 0.33 else 'Continue current pace'}")
